...
const mongoUri = process.env.DB_URI || config.connection;
...
const connectToMongoDb = require('./utilities');
const app = express();//it means create express application
...
app.post("/add-note", authenticateToken, async (req, res) => {
    ...
    try {
        ...
        return res.json({
            error: false,
            note,
            message: "Note added seccessfully",
        });
    } catch (error) {
...
app.put("/update-note-pinned/:noteId", authenticateToken, async (req, res) => {
    ...
    // Validate that isPinned is provided in the request body
